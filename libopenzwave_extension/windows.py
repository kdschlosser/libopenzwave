...
class Extension(extension_base.Extension):
    ...
    def __call__(self, build_ext):
        ...
        self.extra_link_args += ['/NODEFAULTLIB:LIBCMT', '/debug:full']
        self.report_config()
    ...
    def __init__(self):
        ...
        if float(environment.visual_c.version.rsplit('.')[0]) > 10.0:
        ...
        python_info = pyMSVC.PythonInfo()

        libraries += python_info.libraries
