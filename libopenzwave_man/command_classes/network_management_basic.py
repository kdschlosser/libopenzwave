...
from libopenzwave.command_classes import COMMAND_CLASS_NETWORK_MANAGEMENT_BASIC

from .. import value_index_panel
from .. import header_panel


class ZWaveNetworkManagementBasic(COMMAND_CLASS_NETWORK_MANAGEMENT_BASIC):
